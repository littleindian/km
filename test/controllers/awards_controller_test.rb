...
class AwardsControllerTest < ActionController::TestCase
  ...
  test "should create award" do
    assert_difference('Award.count') do
      post :create, award: { accepted: @award.accepted, awardGiverName: @award.awardGiverName, awardLink: @award.awardLink, userid: @award.userid }
    end
  ...
  test "should update award" do
    patch :update, id: @award, award: { accepted: @award.accepted, awardGiverName: @award.awardGiverName, awardLink: @award.awardLink, userid: @award.userid }
    assert_redirected_to award_path(assigns(:award))
  end
